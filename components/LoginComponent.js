            ...
            <View style={styles.container} >
                ...
                <View style={styles.formButton}>
                    <Button
                        ...
                        title='Login'
                        icon={<Icon name='sign-in' type='font-awesome' color='#fff' size={24} />}
            ...
            <View style={styles.container} >
                ...
                <View style={styles.formButton}>
                    <Button
                        ...
                        title='Register'
                        icon={<Icon name='user-plus' type='font-awesome' color='#fff' size={24} />}
                        buttonStyle={{backgroundColor: '#512DA8'}}
                        />
                </View>
            </View>
...
const LoginBottomTab = createBottomTabNavigator();
...
class Login extends React.Component {
    ...
    render() {
        return(
            <LoginBottomTab.Navigator tabBarOptions={this.state.tabBarOptions}>
                <LoginBottomTab.Screen name='Login' component={LoginTab}/>
                <LoginBottomTab.Screen name='Register' component={RegisterTab}/>
            </LoginBottomTab.Navigator>
        );
    }
}
